...
bool VerificationCommand::isValidCommandWord(string commandWord){
	...
	if(commandWord == "add" || commandWord == "delete" || commandWord == "update" || commandWord =="undo" || commandWord =="done" || commandWord == "display" || commandWord =="help" || commandWord =="exit" || commandWord == "clear" || commandWord == "displaydone" || commandWord =="displaytoday"){
