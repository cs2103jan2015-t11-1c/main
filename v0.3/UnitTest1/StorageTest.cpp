...
namespace StorageTest
{
	...
	public:
		...
		TEST_METHOD(createEvent){
			Event sampleEvent("FinishProject","5","april","2359");

			std:: string expected[1] = { "FinishProject is due 5 april 2359" };
		...
		{	Event sampleEvent("FinishProject","5","april","2359");
			...
			sampleEvent.changeEndMonth("May");
			std:: string expected[1] = { "FinishProject is due 6 May 2359" };
			Assert::AreEqual(expected[0],sampleEvent.readEvent());
		}
		TEST_METHOD(changeEndTime)
		{	Event sampleEvent("FinishProject","5","april","2359");
			sampleEvent.changeEndTime("2300");
			std:: string expected[1] = { "FinishProject is due 6 May 2300" };
			Assert::AreEqual(expected[0],sampleEvent.readEvent());
		}
	...
	public:
		...
		TEST_METHOD(deleteEventFromEventlist){
			Event sampleEvent1("IncompleteProject","2","april","2359");
			Event sampleEvent2("FinishProject","5","april","2359");
			Eventlist sampleEventList;
